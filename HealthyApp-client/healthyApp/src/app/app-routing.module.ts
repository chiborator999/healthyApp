...
const routes: Routes = [
  ...
  { path: 'editBook/:id', component: EditBookComponent, canActivate: [RoleGuardService], data: { expectedRole: 'Admin' }},
  ...
  { path: 'editProduct/:id', component: EditProductComponent, canActivate: [RoleGuardService], data: { expectedRole: 'Admin' }},
  ...
  { path: 'editExercise/:id', component: EditExerciseComponent, canActivate: [RoleGuardService], data: { expectedRole: 'Admin' }},
];
